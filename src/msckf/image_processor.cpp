...
bool ImageProcessor::initialize() {
  ...
  CameraMeasurementPtr ImageProcessor::stereoCallback(const sensor_msgs::ImageConstPtr& cam0_img,const sensor_msgs::ImageConstPtr& cam1_img)
{
  ...
  //cv::imshow("1",cam0_curr_img_ptr->image);
  //cv::waitKey(0);
